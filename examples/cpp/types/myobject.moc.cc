/****************************************************************************
** Meta object code from reading C++ file 'myobject.hh'
**
** Created: Sun Jan 30 18:55:51 2011
...
#error "The header file 'myobject.hh' doesn't include <QObject>."
...
int MyQObject::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< Mystruct*>(_v) = mystruct(); break;
        case 1: *reinterpret_cast< QMainWindow**>(_v) = mainwindow(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setMystruct(*reinterpret_cast< Mystruct*>(_v)); break;
        case 1: setMainwindow(*reinterpret_cast< QMainWindow**>(_v)); break;
        }
        _id -= 2;
